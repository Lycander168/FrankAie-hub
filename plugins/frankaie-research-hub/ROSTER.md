...
> 總機負責「分流」、工具負責「執行產出」、基礎建設負責「記憶/品質/驗證」。
> **投研團隊**：另有 `tw-stock-experts`（10 位 20 年資歷台股投資專家），專評持倉健康度與最佳投組（教育/模擬非投資建議）。共 34 個 skill。
...
### 📈 台股投研團隊（tw-stock-experts）— 10 人 · 平均 20 年資歷
> ⚠️ 教育/模擬推估，非投資建議；過去績效不代表未來。專評台股持倉健康度、每日盤勢提醒與最佳投組。
...
| 看台股持倉健康度 / 投組 / 高股息重疊 / 股債配置 / 再平衡 / 開盤盤中提醒（教育模擬非投資建議）| `tw-stock-experts` |
